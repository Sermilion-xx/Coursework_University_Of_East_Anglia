 ...
 * @author Sermilion
 */
@WebServlet(name = "RemoveFromFavForm", urlPatterns = {"/RemoveFromFavForm"})
public class RemoveFromFavForm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             ...
             article.setIsFavourite(false);
             Favourites fav = statelessb.getFavourites2(user, article);
             if (statelessb.RemoveFromFavourites(fav)) {
